...
export const SubscribeFormBase = memo(
  (props: {
    ...
    const buttonLabel = useMemo(
      () => props.stateToButtonLabel?.({ isLoading, status }) || "",
      [status, isLoading, props]
    );
    const caption = useMemo(
      () => props.stateToCaption?.({ isLoading, status }) || "",
      [status, isLoading, props]
    );
      ...
      >
        ...
        >
          ...
          <Icon
            ...
            className={clsx("ml-2 -mt-0.5 w-[.65em] h-[.65em]", {
              "lg:group-hover:ml-4 lg:group-hover:-mr-2 transition-all":
                !props.isStaticArrow,
            })}
          />
        </button>
        ...
        <div
          className={clsx(
            ...
            {
              "mt-2 absolute right-0 -bottom-2 translate-y-full":
                !props.staticCaption,
            },
        ...
        >
          <Icon
            name={status === "error" ? "exclamation-mark" : "check"}
...
SubscribeFormBase.displayName = "SubscribeFormBase";
