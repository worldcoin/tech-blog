...
**In this article, we show that iris recognition technology is capable of distinguishing individuals on a billion people scale. We discuss different operating modes and evaluate the expected failure rates as the user base grows.**
