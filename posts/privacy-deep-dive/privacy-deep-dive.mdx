...
![Screenshots of privacy and personal data deletion request in the World App.](./b-privacy-1.jpg "Screenshots of privacy and personal data deletion request in the World App.")
...
![Diagram outlining the enrollment process to obtain a verified World ID at an Orb.](./b-privacy-2.svg "Diagram outlining the enrollment process to obtain a verified World ID at an Orb.")
...
![Diagram of an iris image transformed into an iris code.](./b-privacy-3.jpg "An iris image transformed into an iris code.")
...
![Diagram outlining how an application verifies someone is a unique human with World ID.](./b-privacy-4.svg "Diagram outlining how an application verifies someone is a unique human with World ID.")
