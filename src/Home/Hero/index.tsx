...
export const Hero = memo(function Hero() {
  return (
    <section className="relative bg-010101 text-ffffff border-b border-010101/10 max-h-[calc(100vh_-_68px)] min-h-[610px] pt-17">
      <div
        className={clsx(
      ...
      >
        <div className="w-min space-y-2 md:space-y-5">
          ...
          <h2 className="text-18 md:text-24 font-serif tracking-[-0.005em]">
      ...
      <div className={clsx(layout.paddingRight2xl, 'z-0 absolute right-0 bottom-0 opacity-50 md:opacity-100')}>
        <Image src={heroImageDark} alt={title} priority />
      </div>
    </section>
  )
})
