...
export const Filter = memo(function Filter(props: {
  ...
  const [selectedCategory, setSelectedCategory] = useState<BlogListFilterValues['category']>()
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        <Icon
          name="triangle"
          className={clsx('w-3 h-3 md:hidden transition-transform', {'rotate-0': !isOn, 'rotate-180': isOn})}
        />
      </FilterItem>
