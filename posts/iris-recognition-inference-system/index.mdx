<Meta>
  ...
  <social-image src="./Meta-Hero-How-to-use-World-App-1600x900px@2x.jpg" />
  <hero-image src="./Hero-Iris-Recognition-Inference-system.svg" />
  <hero-description>
    Worldcoin requires a system that can accurately verify one's uniqueness among billions of users. In this article, we will explain how our biometric pipeline processes iris images to enable uniqueness verification on a large scale.
  </hero-description>
</Meta>
...
![Scheme of the normalization process.](./Fig.3-[IRIS-RECOGNITION]@2x.png "Scheme of the normalization process.")
...
![Normalized iris texture. The texture is sharp and its patterns are clearly visible.](./Fig.4-[IRIS-RECOGNITION]@2x.png "Normalized iris texture. The texture is sharp and its patterns are clearly visible.")
...
![Final iris code. This is the anonymized iris texture expressing one's uniqueness](./Fig.5-[IRIS-RECOGNITION]@2x.png "Final iris code. This is the anonymized iris texture expressing one's uniqueness")
...
![Match and Non-Match Distribution](./Fig.6-Graph-Match-and-non-match@2x-2.png)
