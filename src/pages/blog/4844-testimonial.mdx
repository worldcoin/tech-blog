...
- [kzg-sequencer implementation](https://github.com/ethereum/kzg-ceremony-sequencer)
- [a ceremony contribution client](https://github.com/worldcoin/kzg-ceremony-client)
- support for cryptography libraries (ECC, KZG)
- coordination / pushing EIP forward in the community

### Summary

We believe that Ethereum should prioritize scaling and coordinate to push EIP4844 forward in a timely manner. Our timeline estimation would be to get the EIP into the Capella/Shanghai hard fork unless a major setback happens.
