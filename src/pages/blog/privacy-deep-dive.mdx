...
<img
  src="https://80b99e7471bc2a2cb26de82.s3.eu-central-1.amazonaws.com/b-privacy-1.jpg"
  alt="Screenshots of privacy and personal data deletion request in the World App."
  width="400px"
/>

_Screenshots of privacy and personal data deletion request in the World App._
...
![Diagram showing the enrollment process for a verified World ID.](https://80b99e7471bc2a2cb26de82.s3.eu-central-1.amazonaws.com/b-privacy-2.png)
...
1. The Orb submits to the signup service a message with the iris code. The message is signed by the Orb's private key which lives in the Trusted Platform Module (TPM), to authenticate the message came from a legitimate Orb.
1. The signup service together with the uniqueness service compares the proposed iris code to all the iris codes previously seen by comparing their Hamming distance. If the distance is below a certain threshold, then the backend considers this signup a duplicate and rejects the enrollment.
...
![Diagram of an iris image transformed into an iris code.](https://80b99e7471bc2a2cb26de82.s3.eu-central-1.amazonaws.com/b-privacy-3.jpg)

_An iris image transformed into an iris code._
...
The system already has very strong privacy assurances, but we plan to go even further. The following is our roadmap and projects that are currently in development for enhanced privacy.
...
![Diagram showing how an application can verify someone is a unique human with World ID.](https://80b99e7471bc2a2cb26de82.s3.eu-central-1.amazonaws.com/b-privacy-4.png)
...
- We are committed to process data in accordance with all applicable laws as stated in our privacy policy. Additionally, we are in dialogue with data protection authorities that are regulating us in the countries we operate in.
- We are planning security and privacy reviews with reputable and independent audit firms that can objectively attest to the privacy of the system.
