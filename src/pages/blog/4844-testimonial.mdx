<Meta>
  <title>Worldcoin EIP-4844 testimonial</title>
  <description>EIP-4844 would help Ethereum increase its data throughput to other scalability solutions and in turn help Worldcoin reach its goal of onboarding a billion users.</description>
