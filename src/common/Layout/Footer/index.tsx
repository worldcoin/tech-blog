...
export const Footer = memo(function Footer(props: {
  ...
  return (
    ...
    >
      <CommonLink
        className="lg:col-start-1 lg:row-start-3 lg:mt-44 mb-8 lg:mb-0 w-min"
        href="/"
      >
      ...
      >
        ...
        <SubscribeForm
          ...
          className="text-8c8c92"
          inputClassName="placeholder-8c8c92"
        />
      </div>
      ...
      >
        ...
        >
          ...
          <SocialLink
            href="https://instagram.com/worldcoin/"
            icon="instagram"
            className={linkClassName}
          />
          ...
          <SocialLink
            href="https://t.me/worldcoin"
            icon="telegram"
            className={linkClassName}
          />
          <SocialLink
            href="https://www.tiktok.com/@worldcoin"
            icon="tiktok"
            className={linkClassName}
          />
          <SocialLink
