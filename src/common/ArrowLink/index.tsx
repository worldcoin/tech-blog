...
const isArrowLinkWithHrefProps = (
  props: ArrowLinkProps
): props is ArrowCommonLinkProps => {
  return "href" in props;
};

export const ArrowLink = memo(function ArrowLink(
  props: ArrowCommonLinkProps | ArrowScrollLinkProps
) {
  ...
  const children = (
    <Fragment>
      ...
      <Icon
        name="arrow-right"
        className="w-3.5 h-3.5 lg:group-hover:translate-x-1.5 transition-transform"
      />
    </Fragment>
  );
