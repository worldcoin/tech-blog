<Meta>
  ...
  <description>EIP-4844 (proto-danksharding) is part of Ethereum's scaling roadmap and will add more data throughput for rollups which will make the network a lot more affordable and enable more resource-intensive applications to exist.</description>
