...
In order to verify the claim on the value of $\widetilde{V}_i(g)$, we run the sumcheck protocol between a prover and verifier. In the last round of sumcheck, the prover sends the value $k$, which is purportedly the value:
